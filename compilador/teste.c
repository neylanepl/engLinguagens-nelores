...
static char INPUT_BUFFER_CLEAR;
...
printf("\n");
scanf("%d", &colunas1);
printf("%s", "Digite os elementos da primeira matriz:\n");
printf("\n");
int i = 0;
int j = 0;
WHILE_0:
...
printf("\n");
scanf("%d", &colunas2);
printf("%s", "Digite os elementos da segunda matriz:\n");
printf("\n");
i=0;
WHILE_4:
...
goto endifIF_0;
elseIF_0:
printf("%s", "A soma das matrizes não é possível (dimensões incompatíveis).");
printf("\n");
endifIF_0:
if (!(colunas1==linhas2)) goto endifIF_1;
i=0;
WHILE_12:
